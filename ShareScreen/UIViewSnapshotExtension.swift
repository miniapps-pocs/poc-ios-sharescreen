...
//  ShareScreen
//
//  Created by TIAGO ALMEIDA DE OLIVEIRA on 21/08/20.
...
extension UIView {
    ...
    // from https://github.com/runmad/WebKitSnapshotTest/blob/master/WebKitSnapshotTest/UIViewSnapshotExtension.swift
